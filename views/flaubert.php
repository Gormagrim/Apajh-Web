<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 text-center m-2">
            <button type="button" class="btn btn-primary" onclick="history.go(-1)" aria-label="Close">Retour</button>
        </div>
    </div>
    <div class="row">
        <div class="offset-1 col-10">
            <div class="row">
                <div class="col-12 offset-sm-1 col-sm-10 connexion videoss text-center">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center wordTitle">
                            <div class="title">
                                <h2 class="wordTitle">La promenade de Flaubert</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 video text-center">
                            <div class="ratio ratio-16x9">
                                <video id="ldsVideo" class="ldsVideo" contextmenu="return false;" oncontextmenu="return false;" controls>
                                    <source src="./assets/video/flaubert.m4v" type="video/mp4">
                                </video>
                            </div>
                        </div>
                    </div>
