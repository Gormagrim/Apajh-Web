    ...
    <div class="row">
        <div class="offset-1 col-10 offset-sm-2 col-sm-8 offset-md-2 col-md-8 offset-lg-2 col-lg-8 offset-xl-2 col-xl-8 acount">
            ...
            <div class="row civility">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <span class="myCivility">Sébastien</span>
                </div>
            </div>
            <div class="row civility">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <span class="myCivility">Larrivée</span>
                </div>
            </div>
            <div class="row civility">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <span class="myCivility">NOYON</span>
                </div>
            </div>
            <div class="row civility">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <span class="myCivility">Développeur</span>
                </div>
            </div>
            <div class="row">
                <div class="col-12 offset-sm-2 col-sm-8 offset-md-2 col-md-8 offset-lg-2 col-lg-8 offset-xl-2 col-xl-8 text-center">
                    <a class="btn btn-secondary modification" href="/webapp/information.php">Modifier mes informations</a>
                </div>
            </div>
        </div>
    </div>
